...
## Bring-up
```bash
wrangler d1 create language-learning-rpg-db
wrangler kv namespace create language-learning-rpg-rate-limit
wrangler r2 bucket create language-learning-rpg-public && wrangler r2 bucket create language-learning-rpg-protected
# fill the ids into wrangler.jsonc, then:
wrangler d1 execute language-learning-rpg-db --file=../../packages/auth/migrations/0001_identity.sql
wrangler d1 execute language-learning-rpg-db --file=../../packages/security/migrations/0001_audit.sql
wrangler d1 execute language-learning-rpg-db --file=./migrations/0002_domain.sql
```
